...
import com.fuevent.api.repository.OrderRepository;
import com.fuevent.api.service.OrderService;
...
/**
 * REST controller for managing {@link com.fuevent.api.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "fuEventApiOrder";
