...
import com.fuevent.api.repository.OrderItemRepository;
import com.fuevent.api.service.OrderItemService;
...
/**
 * REST controller for managing {@link com.fuevent.api.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemResource {
    ...
    private static final String ENTITY_NAME = "fuEventApiOrderItem";
