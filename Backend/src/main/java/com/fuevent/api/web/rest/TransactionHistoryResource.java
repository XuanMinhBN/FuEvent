...
import com.fuevent.api.service.TransactionHistoryService;
...
/**
 * REST controller for managing {@link com.fuevent.api.domain.TransactionHistory}.
 */
@RestController
@RequestMapping("/api")
public class TransactionHistoryResource {
    ...
    private static final String ENTITY_NAME = "fuEventApiTransactionHistory";
