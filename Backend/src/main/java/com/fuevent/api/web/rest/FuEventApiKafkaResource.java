...
@RestController
@RequestMapping("/api/fu-event-api-kafka")
public class FuEventApiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FuEventApiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FuEventApiKafkaResource(KafkaProperties kafkaProperties) {
