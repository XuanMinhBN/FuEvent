...
import com.fuevent.api.repository.ReviewRepository;
import com.fuevent.api.service.ReviewService;
...
/**
 * REST controller for managing {@link com.fuevent.api.domain.Review}.
 */
@RestController
@RequestMapping("/api")
public class ReviewResource {
    ...
    private static final String ENTITY_NAME = "fuEventApiReview";
