...
import com.fuevent.api.repository.PaymentRepository;
import com.fuevent.api.service.PaymentService;
...
/**
 * REST controller for managing {@link com.fuevent.api.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
    ...
    private static final String ENTITY_NAME = "fuEventApiPayment";
