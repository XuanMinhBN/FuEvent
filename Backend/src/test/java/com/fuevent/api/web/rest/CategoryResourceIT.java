...
import com.fuevent.api.repository.CategoryRepository;
import com.fuevent.api.service.dto.CategoryDTO;
import com.fuevent.api.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDescriptionContentType()).isEqualTo(DEFAULT_DESCRIPTION_CONTENT_TYPE);
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).descriptionContentType(UPDATED_DESCRIPTION_CONTENT_TYPE);
        ...
        assertThat(testCategory.getDescriptionContentType()).isEqualTo(UPDATED_DESCRIPTION_CONTENT_TYPE);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).descriptionContentType(UPDATED_DESCRIPTION_CONTENT_TYPE);
