...
import com.fuevent.api.repository.EventRepository;
import com.fuevent.api.service.dto.EventDTO;
import com.fuevent.api.service.mapper.EventMapper;
...
class EventResourceIT {
    ...
    private static final EventStatus DEFAULT_STATUS = EventStatus.PENDING;
    private static final EventStatus UPDATED_STATUS = EventStatus.APPROVED;
    ...
    private static final String DEFAULT_ORGANIZER_LOGIN = "AAAAAAAAAA";
    private static final String UPDATED_ORGANIZER_LOGIN = "BBBBBBBBBB";
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event()
            ...
            .organizerLogin(DEFAULT_ORGANIZER_LOGIN);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event()
            ...
            .organizerLogin(UPDATED_ORGANIZER_LOGIN);
        return event;
    }
    ...
    void createEvent() throws Exception {
        ...
        assertThat(testEvent.getPosterUrl()).isEqualTo(DEFAULT_POSTER_URL);
        assertThat(testEvent.getStartTime()).isEqualTo(DEFAULT_START_TIME);
        assertThat(testEvent.getEndTime()).isEqualTo(DEFAULT_END_TIME);
        assertThat(testEvent.getOrganizerLogin()).isEqualTo(DEFAULT_ORGANIZER_LOGIN);
    }
    ...
    void getAllEvents() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.[*].organizerLogin").value(hasItem(DEFAULT_ORGANIZER_LOGIN)));
    }
    ...
    void getEvent() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.organizerLogin").value(DEFAULT_ORGANIZER_LOGIN));
    }
    ...
    void putNewEvent() throws Exception {
        ...
        assertThat(testEvent.getPosterUrl()).isEqualTo(UPDATED_POSTER_URL);
        assertThat(testEvent.getStartTime()).isEqualTo(UPDATED_START_TIME);
        assertThat(testEvent.getEndTime()).isEqualTo(UPDATED_END_TIME);
        assertThat(testEvent.getOrganizerLogin()).isEqualTo(UPDATED_ORGANIZER_LOGIN);
    }
