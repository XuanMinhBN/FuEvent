...
import com.fuevent.api.domain.Notification;
import com.fuevent.api.repository.NotificationRepository;
import com.fuevent.api.service.dto.NotificationDTO;
import com.fuevent.api.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    void putNewNotification() throws Exception {
        ...
        updatedNotification.title(UPDATED_TITLE).message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ).userLogin(UPDATED_USER_LOGIN);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.isRead(UPDATED_IS_READ).userLogin(UPDATED_USER_LOGIN);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.title(UPDATED_TITLE).message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ).userLogin(UPDATED_USER_LOGIN);
