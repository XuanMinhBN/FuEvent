...
class WalletResourceIT {
    ...
    public static Wallet createEntity(EntityManager em) {
        Wallet wallet = new Wallet().balance(DEFAULT_BALANCE).userLogin(DEFAULT_USER_LOGIN);
        return wallet;
    }
    ...
    public static Wallet createUpdatedEntity(EntityManager em) {
        Wallet wallet = new Wallet().balance(UPDATED_BALANCE).userLogin(UPDATED_USER_LOGIN);
        return wallet;
    }
    ...
    void createWallet() throws Exception {
        ...
        assertThat(testWallet.getUserLogin()).isEqualTo(DEFAULT_USER_LOGIN);
    }
    ...
    void putNewWallet() throws Exception {
        ...
        updatedWallet.balance(UPDATED_BALANCE).userLogin(UPDATED_USER_LOGIN);
        ...
        assertThat(testWallet.getUserLogin()).isEqualTo(UPDATED_USER_LOGIN);
    }
    ...
    void partialUpdateWalletWithPatch() throws Exception {
        ...
        partialUpdatedWallet.balance(UPDATED_BALANCE).userLogin(UPDATED_USER_LOGIN);
