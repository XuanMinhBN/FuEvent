...
@RestController
@RequestMapping("/api/fu-event-ui-kafka")
public class FuEventUiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FuEventUiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public FuEventUiKafkaResource(KafkaProperties kafkaProperties) {
