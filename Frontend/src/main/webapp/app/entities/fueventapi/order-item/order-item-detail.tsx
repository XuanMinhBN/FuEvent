    ...
    <Row>
      <Col md="8">
        <h2 data-cy="orderItemDetailsHeading">
          <Translate contentKey="fuEventUiApp.fueventapiOrderItem.detail.title">OrderItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="quantity">
              <Translate contentKey="fuEventUiApp.fueventapiOrderItem.quantity">Quantity</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.quantity}</dd>
          <dt>
            <span id="unitPrice">
              <Translate contentKey="fuEventUiApp.fueventapiOrderItem.unitPrice">Unit Price</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.unitPrice}</dd>
          <dt>
            <Translate contentKey="fuEventUiApp.fueventapiOrderItem.product">Product</Translate>
          </dt>
          <dd>{orderItemEntity.product ? orderItemEntity.product.id : ''}</dd>
          <dt>
            <Translate contentKey="fuEventUiApp.fueventapiOrderItem.order">Order</Translate>
          </dt>
