...
export const OrderItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.fueventapiOrderItem.delete.question">
        <Translate contentKey="fuEventUiApp.fueventapiOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
