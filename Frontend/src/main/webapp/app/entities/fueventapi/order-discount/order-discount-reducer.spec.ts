...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERDISCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERDISCOUNT actions', async () => {
      const expectedActions = [
        {
