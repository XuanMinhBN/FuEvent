...
export const CategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.fueventapiCategory.delete.question">
        <Translate contentKey="fuEventUiApp.fueventapiCategory.delete.question" interpolate={{ id: categoryEntity.id }}>
