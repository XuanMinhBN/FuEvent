...
export const PaymentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.fueventapiPayment.delete.question">
        <Translate contentKey="fuEventUiApp.fueventapiPayment.delete.question" interpolate={{ id: paymentEntity.id }}>
