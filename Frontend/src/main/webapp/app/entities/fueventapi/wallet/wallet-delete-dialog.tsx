...
export const WalletDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.fueventapiWallet.delete.question">
        <Translate contentKey="fuEventUiApp.fueventapiWallet.delete.question" interpolate={{ id: walletEntity.id }}>
