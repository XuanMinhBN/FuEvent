...
export const ProductDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.fueventapiProduct.delete.question">
        <Translate contentKey="fuEventUiApp.fueventapiProduct.delete.question" interpolate={{ id: productEntity.id }}>
