    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationDetailsHeading">
          <Translate contentKey="fuEventUiApp.fueventapiNotification.detail.title">Notification</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="fuEventUiApp.fueventapiNotification.title">Title</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.title}</dd>
          <dt>
            <span id="message">
              <Translate contentKey="fuEventUiApp.fueventapiNotification.message">Message</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.message}</dd>
          <dt>
            <span id="isRead">
              <Translate contentKey="fuEventUiApp.fueventapiNotification.isRead">Is Read</Translate>
            </span>
          </dt>
