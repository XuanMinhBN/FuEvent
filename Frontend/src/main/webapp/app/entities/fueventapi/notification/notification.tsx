  ...
  return (
    <div>
      <h2 id="notification-heading" data-cy="NotificationHeading">
        <Translate contentKey="fuEventUiApp.fueventapiNotification.home.title">Notifications</Translate>
        ...
        {notificationList && notificationList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fuEventUiApp.fueventapiNotification.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="fuEventUiApp.fueventapiNotification.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('message')}>
                  <Translate contentKey="fuEventUiApp.fueventapiNotification.message">Message</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isRead')}>
                  <Translate contentKey="fuEventUiApp.fueventapiNotification.isRead">Is Read</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('userLogin')}>
                  <Translate contentKey="fuEventUiApp.fueventapiNotification.userLogin">User Login</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fuEventUiApp.fueventapiNotification.home.notFound">No Notifications found</Translate>
            </div>
          )
        )}
      </div>
