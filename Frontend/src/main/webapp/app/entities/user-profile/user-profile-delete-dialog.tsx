...
export const UserProfileDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fuEventUiApp.userProfile.delete.question">
        <Translate contentKey="fuEventUiApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
